    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="border-b border-gray-100 sticky top-0 z-10 bg-white/90 backdrop-blur">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          <span className="text-xl font-bold text-indigo-600 tracking-tight">Vega</span>
      ...
      {/* Hero */}
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 sm:py-28 bg-gradient-to-b from-indigo-50/60 to-white">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight max-w-3xl">
          ...
          <span className="text-indigo-600">organizada y con foco</span>
        </h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          ...
          {!user && (
            <button
              onClick={() => navigate('/login')}
              className="inline-flex items-center justify-center gap-2 border border-gray-200 text-gray-700 font-semibold px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors text-base"
            >
              Iniciar sesión
            </button>
          )}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="flex flex-col gap-3 p-6 rounded-2xl border border-gray-100 bg-gray-50 hover:shadow-sm transition-shadow"
              >
